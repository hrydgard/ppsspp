./native/tools/build/atlastool atlasscript.txt ui 8888 && cp ui_atlas.zim assets && mv ui_atlas.zim android/assets && mv ui_atlas.h UI
...
diff -I'^//.*' -D USING_QT_UI ui_atlas.cpp ui_atlas_lowmem.cpp > UI/ui_atlas.cpp
