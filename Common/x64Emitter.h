...
#undef CALL
	...
	// Shift
	void ROL(int bits, const OpArg &dest, OpArg shift);
	void ROR(int bits, const OpArg &dest, OpArg shift);
	void RCL(int bits, const OpArg &dest, OpArg shift);
	void RCR(int bits, const OpArg &dest, OpArg shift);
	void SHL(int bits, const OpArg &dest, OpArg shift);
	void SHR(int bits, const OpArg &dest, OpArg shift);
	void SAR(int bits, const OpArg &dest, OpArg shift);
	...
	inline void ROUNDNEARSS(X64Reg dest, const OpArg &arg) { ROUNDSS(dest, arg, FROUND_NEAREST); }
	inline void ROUNDFLOORSS(X64Reg dest, const OpArg &arg) { ROUNDSS(dest, arg, FROUND_FLOOR); }
	inline void ROUNDCEILSS(X64Reg dest, const OpArg &arg) { ROUNDSS(dest, arg, FROUND_CEIL); }
	inline void ROUNDZEROSS(X64Reg dest, const OpArg &arg) { ROUNDSS(dest, arg, FROUND_ZERO); }

	inline void ROUNDNEARSD(X64Reg dest, const OpArg &arg) { ROUNDSD(dest, arg, FROUND_NEAREST); }
	inline void ROUNDFLOORSD(X64Reg dest, const OpArg &arg) { ROUNDSD(dest, arg, FROUND_FLOOR); }
	inline void ROUNDCEILSD(X64Reg dest, const OpArg &arg) { ROUNDSD(dest, arg, FROUND_CEIL); }
	inline void ROUNDZEROSD(X64Reg dest, const OpArg &arg) { ROUNDSD(dest, arg, FROUND_ZERO); }

	inline void ROUNDNEARPS(X64Reg dest, const OpArg &arg) { ROUNDPS(dest, arg, FROUND_NEAREST); }
	inline void ROUNDFLOORPS(X64Reg dest, const OpArg &arg) { ROUNDPS(dest, arg, FROUND_FLOOR); }
	inline void ROUNDCEILPS(X64Reg dest, const OpArg &arg) { ROUNDPS(dest, arg, FROUND_CEIL); }
	inline void ROUNDZEROPS(X64Reg dest, const OpArg &arg) { ROUNDPS(dest, arg, FROUND_ZERO); }

	inline void ROUNDNEARPD(X64Reg dest, const OpArg &arg) { ROUNDPD(dest, arg, FROUND_NEAREST); }
	inline void ROUNDFLOORPD(X64Reg dest, const OpArg &arg) { ROUNDPD(dest, arg, FROUND_FLOOR); }
	inline void ROUNDCEILPD(X64Reg dest, const OpArg &arg) { ROUNDPD(dest, arg, FROUND_CEIL); }
	inline void ROUNDZEROPD(X64Reg dest, const OpArg &arg) { ROUNDPD(dest, arg, FROUND_ZERO); }
