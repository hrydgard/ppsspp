...
void GameSettingsScreen::CreateViews() {
	...
	TabHolder *tabHolder = new TabHolder(ORIENT_VERTICAL, 200, new LinearLayoutParams(700, FILL_PARENT, actionMenuMargins));
	root_->Add(tabHolder);
	...
	graphicsSettings->Add(new CheckBox(&Vsync, gs->T("VSync")));
