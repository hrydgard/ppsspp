...
void GameSettingsScreen::CreateViews() {
	...
	graphicsSettings->Add(new CheckBox(&g_Config.bLowQualitySplineBezier, gs->T("Low Quality Spline/Bezier Curves")));
...
#ifdef _WIN32
	graphicsSettings->Add(new CheckBox(&g_Config.bVSync, gs->T("Vertical Sync")));
	...
	// In case we will add MSAA in the future here.
	...
	graphicsSettings->Add(new PopupMultiChoice(&g_Config.iTexFiltering, gs->T("Texture Filtering"), texFilters, 1, ARRAY_SIZE(texFilters), gs, screenManager()));
	...
	// We're normally use software rendering to debug 
#ifdef _WIN32
...
//#endif
	...
	systemSettings->Add(new ItemHeader(s->T("Interface Language")));
