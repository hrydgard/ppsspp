...
void LogoScreen::render() {
	...
	ui_draw2d.DrawText(UBUNTU24, "Created by Henrik Rydg\xE5rd", dp_xres / 2, dp_yres / 2 + 40, colorAlpha(0xFFFFFFFF, alphaText), ALIGN_CENTER);
