...
class CustomKeyScreen : public UIDialogScreenWithGameBackground {
public:
	CustomKeyScreen(const Path &gamePath, int id) : UIDialogScreenWithGameBackground(gamePath), id_(id) {}
