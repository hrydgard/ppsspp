...
static const CommandTableEntry commandTable[] = {
	...
	{ GE_CMD_FRAMEBUFPTR, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF, &GPU_Vulkan::Execute_FramebufType },
	{ GE_CMD_FRAMEBUFWIDTH, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF, &GPU_Vulkan::Execute_FramebufType },
	{ GE_CMD_FRAMEBUFPIXFORMAT, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF, &GPU_Vulkan::Execute_FramebufType },
	...
	{ GE_CMD_TEXSIZE1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE3, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE4, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE5, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE6, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXSIZE7, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexSizeN },
	{ GE_CMD_TEXFORMAT, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_IMAGE, &GPU_Vulkan::Execute_TexFormat },
	{ GE_CMD_TEXLEVEL, FLAG_EXECUTEONCHANGE, 0, &GPU_Vulkan::Execute_TexLevel },
	{ GE_CMD_TEXADDR0, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_IMAGE, &GPU_Vulkan::Execute_TexAddr0 },
	{ GE_CMD_TEXADDR1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR3, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR4, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR5, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR6, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXADDR7, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexAddrN },
	{ GE_CMD_TEXBUFWIDTH0, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_IMAGE, &GPU_Vulkan::Execute_TexBufw0 },
	{ GE_CMD_TEXBUFWIDTH1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH3, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH4, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH5, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH6, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	{ GE_CMD_TEXBUFWIDTH7, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexBufwN },
	...
	{ GE_CMD_CLUTFORMAT, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_ClutFormat },
	...
	{ GE_CMD_TEXMODE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexParamType },
	...
	{ GE_CMD_TEXFILTER, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexParamType },
	{ GE_CMD_TEXWRAP, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_TexParamType },
	...
	{ GE_CMD_COLORREF, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_ALPHACOLORREF, &GPU_Vulkan::Execute_ColorRef },
	...
	// Viewport.
	{ GE_CMD_VIEWPORTXSCALE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_ViewportType },
	{ GE_CMD_VIEWPORTYSCALE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_ViewportType },
	{ GE_CMD_VIEWPORTXCENTER, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_ViewportType },
	{ GE_CMD_VIEWPORTYCENTER, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_ViewportType },
	{ GE_CMD_VIEWPORTZSCALE, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS | DIRTY_PROJMATRIX | DIRTY_DEPTHRANGE, &GPU_Vulkan::Execute_ViewportZType },
	{ GE_CMD_VIEWPORTZCENTER, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF | DIRTY_TEXTURE_PARAMS | DIRTY_PROJMATRIX | DIRTY_DEPTHRANGE, &GPU_Vulkan::Execute_ViewportZType },

	// Region
	{ GE_CMD_REGION1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF|DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_Region },
	{ GE_CMD_REGION2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF|DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_Region },

	// Scissor
	{ GE_CMD_SCISSOR1, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF|DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_Scissor },
	{ GE_CMD_SCISSOR2, FLAG_FLUSHBEFOREONCHANGE | FLAG_EXECUTEONCHANGE, DIRTY_FRAMEBUF|DIRTY_TEXTURE_PARAMS, &GPU_Vulkan::Execute_Scissor },
