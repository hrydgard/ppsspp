...
#include <strings.h>  // strcasecmp: newlib does not reach it through <cstring>
#endif
...
static constexpr GECmdInfo geCmdInfo[] = {
	...
	{ GE_CMD_END, "end", GECmdFormat::DATA16, "End", CMD_FMT_HEX_AND_INT },
	...
	{ GE_CMD_PATCHDIVISION, "patchdivision", GECmdFormat::PATCH_DIVISION, "Patch division", CMD_FMT_HEX_AND_INT },
	...
	{ GE_CMD_MINZ, "minz", GECmdFormat::DATA16, "Min Z", CMD_FMT_HEX_AND_INT},
	{ GE_CMD_MAXZ, "maxz", GECmdFormat::DATA16, "Max Z", CMD_FMT_HEX_AND_INT},
	...
	{ GE_CMD_VSCZ, "immz", GECmdFormat::DATA16, "Imm vertex Z", CMD_FMT_HEX_AND_INT},
