...
enum class RasterizerStateFlags {
	...
	OPTIMIZED = 0x00010000,
	OPTIMIZED_BLEND_SRC = 0x00020000,
	OPTIMIZED_BLEND_DST = 0x00040000,
	OPTIMIZED_BLEND_OFF = 0x00080000,
	OPTIMIZED_TEXREPLACE = 0x00100000,
	OPTIMIZED_FOG_OFF = 0x00200000,
	OPTIMIZED_ALPHATEST_OFF_NE = 0x00400000,
	OPTIMIZED_ALPHATEST_OFF_GT = 0x00800000,
	OPTIMIZED_ALPHATEST_ON = 0x01000000,
