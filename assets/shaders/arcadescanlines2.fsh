...
float scanlines = 0.2;						//default 0.2
float brighten = 0.2;						//default 0.2
float colorshift = 0.0;						//default 0.0
float lineblur = 0.15;						//default 0.15
float phosphorgrid = 0.0;					//default 0.0
float screencurve = 0.0;					//default 0.0
float interlacing = 0.0;					//default 0.0
