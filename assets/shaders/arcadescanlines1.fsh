...
float brighten = 0.4;						//default 0.4
float colorshift = 0.5;						//default 0.5
float lineblur = 0.25;						//default 0.25
float phosphorgrid = 0.2;					//default 0.2
float screencurve = 0.15;					//default 0.15
