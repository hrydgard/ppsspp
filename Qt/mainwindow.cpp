...
void MainWindow::createMenus()
{
	...
	fileMenu->add(new MenuAction(this, SLOT(openAct()),       QT_TR_NOOP("&Load...")))
		->addEnableState(UISTATE_MENU);
	fileMenu->add(new MenuAction(this, SLOT(opendirAct()),       QT_TR_NOOP("Open &directory...")))
		->addEnableState(UISTATE_MENU);
	...
	recordMenu->add(new MenuAction(this, SLOT(useLosslessCodecAct()),        QT_TR_NOOP("&Use lossless video codec (FFV1)")))
	...
	/*emuMenu->add(new MenuAction(this, SLOT(runAct()),         QT_TR_NOOP("&Run")))
	...
	emuMenu->add(new MenuAction(this, SLOT(stopAct()),       QT_TR_NOOP("&Stop"), Qt::CTRL + Qt::Key_W))
		->addEnableState(UISTATE_INGAME);
	emuMenu->add(new MenuAction(this, SLOT(resetAct()),       QT_TR_NOOP("Re&set"), Qt::CTRL + Qt::Key_B))
		->addEnableState(UISTATE_INGAME);
	...
	gameSettingsMenu->add(new MenuAction(this, SLOT(fullscrAct()), QT_TR_NOOP("Fu&llscreen"), Qt::Key_F11))
#else
	...
	helpMenu->add(new MenuAction(this, SLOT(websiteAct()),    QT_TR_NOOP("Visit www.&ppsspp.org"), QKeySequence::HelpContents));
