...
protected:
	...
	void UpdateButtons();
	bool IsButtonPressed(int checkButton) const;
	bool IsButtonHeld(int checkButton, int &framesHeld, int framesHeldThreshold = 30, int framesHeldRepeatRate = 10) const;
