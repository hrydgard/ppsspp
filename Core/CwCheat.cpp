				...
				if (arg >> 28 == 0x0 || arg >> 28 == 0x2) { // 8Bit & 16Bit ignore next line cheat code
					...
					if (true)
						if (Memory::IsValidAddress(addr1) && Memory::IsValidAddress(addr2)) {
							...
							switch (arg2 >> 4) {
							case 0x0: // 8Bit
								int memoryValue1 = Memory::Read_U8(addr1);
								int memoryValue2 = Memory::Read_U8(addr2);
								break;
							case 0x1: // 16Bit
								int memoryValue1 = Memory::Read_U16(addr1);
								int memoryValue2 = Memory::Read_U16(addr2);
								break;
							case 0x2: // 32Bit
								int memoryValue1 = Memory::Read_U32(addr1);
								int memoryValue2 = Memory::Read_U32(addr2);
								break;
							default:
								break;
							}
