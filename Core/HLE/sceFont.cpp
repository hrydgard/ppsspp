...
// Most UMDs carry a firmware updater, so if we have no real fonts yet we can pull them out of
...
static void __LoadInternalFonts() {
	...
	} else if (!pspFileSystem.GetFileInfo(std::string(g_nandFontPath) + "ltn0.pgf").exists) {
