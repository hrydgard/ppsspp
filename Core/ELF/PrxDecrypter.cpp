...
// The 5.xx member of the same family, read out of that firmware's own mesg_led_02g.prx: its tag
// table is 24-byte entries of tag + 16-byte key + padding, and the two entries around this one
// hold keys330_1 and keys505_a byte for byte, which is how the layout was confirmed. Without it
// the 5.50 XMB couldn't decrypt flash0:/vsh/etc/index_02g.dat, so it drew no icons and gave up
// with the red "a serious error has occurred" screen.
static const u8 keys_9DC14891_4[] = {0x1A, 0x26, 0xFD, 0x16, 0x32, 0x0E, 0x71, 0xD0, 0xDC, 0xD1, 0x3C, 0xE5, 0x53, 0xD5, 0x44, 0x99};
...
static const TAG_INFO2 g_tagInfo2[] =
{
	...
	{ 0x0B2B11F0, keys_9DC14891_4, 0x5C },
