...
static ConfigSetting graphicsSettings[] = {
	...
	ConfigSetting("FPSCounterPosition", &g_Config.iFPSCounterPosition, 0, true, true),
	ConfigSetting("FPSCounterColorABGR", &g_Config.uFPSCounterColor, 0xFF3FFF3F, true, true),
	ConfigSetting("FPSCounterSize", &g_Config.fFPSCounterSize, 0.7f, true, true),
	ConfigSetting("FPSCounterShadow", &g_Config.bFPSCounterShadow, true, true, true),
	ConfigSetting("FPSCounterBackgroundABGR", &g_Config.uFPSCounterBackground, 0x00000000U, true, true),
