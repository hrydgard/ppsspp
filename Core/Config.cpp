...
static ConfigSetting graphicsSettings[] = {
	...
	ConfigSetting("UnToggleFpsLimit", &g_Config.bUnToggleFpsLimit, false, true, true),
	...
	ConfigSetting("DirtyOnClearOrRSelf", &g_Config.bDirtyClearRSelf, false, true, true),
...
static ConfigSetting soundSettings[] = {
	...
	ConfigSetting("SpeedLimitHack", &g_Config.bSpeedLimitHack, false , true, true),
