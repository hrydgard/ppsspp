...
public:
	...
	inline bool IsBackendOpenGL() const {
		return iGPUBackend == GPU_BACKEND_OPENGL || iGPUBackend == GPU_BACKEND_HIGH_OPENGL;
	}

	inline bool IsBackendD3D9() const {
#ifdef _WIN32
		return iGPUBackend == GPU_BACKEND_DIRECT3D9;
#else
		return false;
#endif
	}
