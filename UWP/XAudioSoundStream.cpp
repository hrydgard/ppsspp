...
public:
  ...
  bool Init( StreamCallback callback, int sampleRate ) override;  // If fails, can safely delete the object
...
bool XAudioBackend::Init( StreamCallback _callback, int sampleRate ) {
  callback_ = _callback;
