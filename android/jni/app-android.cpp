...
public:
	virtual bool Init(ANativeWindow *wnd, int desiredBackbufferSizeX, int desiredBackbufferSizeY, int backbufferFormat) = 0;
};
...
public:
	...
	bool Init(ANativeWindow *wnd, int desiredBackbufferSizeX, int desiredBackbufferSizeY, int backbufferFormat) override;
	void Shutdown() override;
	void SwapInterval(int interval) override;
	void SwapBuffers() override;
...
bool AndroidVulkanContext::Init(ANativeWindow *wnd, int desiredBackbufferSizeX, int desiredBackbufferSizeY, int backbufferFormat) {
	if (g_Vulkan) {
		return false;
	}
